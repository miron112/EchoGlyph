  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <section className="mb-8 max-w-4xl">
        <p className="text-sm font-semibold uppercase text-pulse">AI music logo lab</p>
        <h1 className="mt-3 text-balance text-4xl font-black text-white sm:text-6xl">
          Sketch a logo. Find the band. Queue the anthems.
        </h1>
        <p className="mt-4 max-w-2xl text-base leading-7 text-white/58">
          EchoGlyph turns rough visual ideas into band matches, confidence scores, and top tracks through a mock-ready recognition API.
        </p>
      </section>
